...
- 🌍 **[QuakeGuard v2.0.0](https://github.com/GiZano/QuakeGuard):** Open-source distributed IoT architecture for real-time seismic monitoring at the edge. Built with C++ (ESP32-C3), Python (FastAPI), and PostgreSQL.
